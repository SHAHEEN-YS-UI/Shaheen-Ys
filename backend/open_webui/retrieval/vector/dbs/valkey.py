...
_NEVER_MATCH_SENTINEL = '__shaheen_ys_ui_valkey_never_match__'
...
class ValkeyClient(VectorDBBase):
    def __init__(self):
        ...
        config = GlideClientConfiguration(
            ...
            client_name='shaheen_ys_ui_vector_store_client',
        )
        try:
        ...
        batch_config = GlideClientConfiguration(
            ...
            client_name='shaheen_ys_ui_vector_store_batch_client',
        )
        try:
